...
stopwordind <-readtext(paste0(DATA_DIR, "Giri/Topikmodel/stopword.txt"))

###sesuikan dengan folder yg berisi file stopword.txt

xx<- scan("D:/Giri/Topikmodel/stopword.txt", what="", sep="\n")
stopwordind$text
...
txts <-readtext(paste0(DATA_DIR, "D:/Giri/Topikmodel/uu27_2007.pdf"))
...
findAssocs(articleTdm, terms = "wilayah", corlimit = 0.8)
##################
